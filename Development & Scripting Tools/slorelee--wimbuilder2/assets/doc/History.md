...
## WimBuilder2 v2026.03.03
这是一个常规更新。添加和改善了以下内容:

* 新增 在ARM64位系统上支持运行x64，x86应用程序。 (感谢 @我是小青蛙)
* 更新 WinXShell 至 v5.1.5.1.e7402e5
  * 改进 UI_Settings 组件 支持 [背景] 设置。 (感谢 @九霜)
* 提交 StartAllBack 与 WinXShell 至 Git 仓库，可通过自动更新获取，完成系统构建。
* 其他 细节更新。  (感谢 @HeyJoe)


## WimBuilder2 v2026.01.01
这是一个主要更新。添加和改善了以下内容:

* 改进 支持更多版本构建。
  * 修复 Windows 11(25H2) Explorer外壳无法正常启动的问题。
  * 修复 Windows 11(25H2) 启动后任务栏无法操作的问题。
  * 修复 Windows 11(25H2) 声音图标无法显示的问题。
  * 修复 Windows 11(25H2) 网络图标无法显示的问题。
  * 修复 Windows 11(26H1) Explorer外壳无法正常启动的问题。
  * 修复 远程桌面服务无法在 Windows 11 新版本上正常工作的问题。
  * 修复 触摸板驱动 无法在 Windows 11 新版本上安装的问题。
* 修复 Administrator账户无法在 Windows 11 (24H2)上正常工作的问题。
* 修复 任务管理器 无法实时显示磁盘使用状况的问题。
* 修复 在某些版本上， 打印到PDF文件 功能无法正常使用的问题。
* 新增 vendor/StartAllBack/24H2目录。构建24H2之后版本时，使用此目录中的最新版本。
* 改进 驱动签名校验文件处理对新版本的支持(24H2, 25H2, 26H1)。
  * 新增 Windows 11(24H2) ARM64  驱动签名校验文件处理。
* 更新 MTP 驱动签名，修复MTP无法正常工作的问题。 (感谢 @nianyueriPE)
* 改进 MTP支持服务处理方法。24H2特定版本之后不再需要 mtpHelper.sys 驱动，使用微软原生支持方式。 (感谢 @YWFhYmJi)
* 改进 更新按钮式样，在关于界面可直接指定下载源(GitHub 或 Gitee)进行更新。
* 更新 StartAllBack 至 v3.9.20
* 更新 WinXShell 至 v5.1.5.1
  * 修复Windows 11(24H2, 25H2, 26H1)显示桌面功能不可用的问题。
* 其他 细节更新。
...
* 改进 支持更多版本构建。
  * 修复 Windows 11(24H2) Explorer外壳无法正常启动的问题。
  * 修复 Windows 11(24H2) 无法显示可用分辨率的问题。
  * 修复 Windows 11(24H2) 变更分辨率后任务栏显示不正的问题。
  * 修复 Windows 11(24H2) 任务管理器无法打开的问题。
  * 修复 Windows 11(24H2) 声音图标无法显示的问题。
  * 修复 Windows 11(24H2) 网络图标无法显示的问题。
  * 修复 Windows 11(24H2) IME输入法图标不显示的问题。
  * 修复 Windows 11(24H2) 摄像头无法正常工作的问题。
  * 修复 Windows 11(24H2) 麦克风无法正常工作的问题。
...
* 改进 支持更多版本构建。
  * 修复 Windows 11(23H2) DWM组件无法正常工作的问题。
  * 修复 Windows 11(23H2) Explorer外壳无法正常启动的问题。
...
* 改进 支持更多版本构建。
  * 修复 Windows 11系统MTP无法正常工作的问题。 (感谢 @nianyueriPE)
  * 修复 Windows 11(22000.194)无法启动无线服务的问题。
  * 修复 Windows 11(22000.194)无法正常启动网络状态服务的问题。
  * 修复 22h1的DWM服务导致外壳无法启动的问题。
...
* 改进 支持更多版本构建。
  ...
  * 修复 精简选项导致21h2的网络状态服务无法启动的问题。
  * 修复 精简选项导致欧洲国家语言系统无法正常使用的问题。 (感谢 @La_Valse)
  * 修复 更新版本系统MTP无法正常工作的问题。 (感谢 @hhh333)
...
* 改进 支持更多版本构建。
  * 修复 新预览版无法使用Administrator账户问题。
  * 修复 新预览版记事本程序没有关联的问题。
  * 修复 新预览版部分驱动没有签名文件导致无法工作的问题。
  * 修复 新预览版上StartIsBack无法正常显示图标的问题。
  * 修复 某些版本DWM组件无法正常工作的问题。
  * 修复 某些版本文件资源管理器的默认显示布局不是`详细信息`的问题。
  * 修复 使用精简选项导致日文系统无法正确显示文字的问题。
* 改进 支持更多应用软件。
...
* 改进 对20H2版本的支持。
  * 修复 使用精简SOFTWARE注册表选项时，登录不正常问题。
* 改进 对21H(2)版本的支持。
  * 修正 Administrator账户登录界面显示不正常问题。
  * 修复 最新预览版32位应用程序无法运行问题。
...
* 改进 精简SOFTWARE选项。
* 更新 WinXShell的UI组件。
  * `UI_SystemInfo`的界面字体，布局进行调整。
  * `UI_WIFI`可直接输入回车键进行连接。
  * `UI_WIFI`的【网络和Internet 设置】可打开【网络连接】页面(更改适配器选项)。
* 更新 WinXShell的Lua脚本。
...
* 更新 vendor\StartIsBack 为2.8.9版本。
* 新增 doc\History.txt 本说明文件。
