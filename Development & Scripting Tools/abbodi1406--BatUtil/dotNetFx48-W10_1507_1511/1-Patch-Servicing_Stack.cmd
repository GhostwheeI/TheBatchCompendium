...
if exist "%_ssu%\CbsCore.old" if exist "%SysPath%\crypt96.dll" (
echo %_wrn%
...
bbe.exe -e "s/CRYPT32.dll/CRYPT96.dll/" -e "s/crypt32.dll/crypt96.dll/" -o CbsCore.dll CbsCore.old >nul 2>&1
