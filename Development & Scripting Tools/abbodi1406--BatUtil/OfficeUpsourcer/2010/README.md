...
patched `mso.dll` to work on Windows XP and Server 2003
...
http://support.microsoft.com/en-us/help/2687521

Technical details about the Office 2010 SP2 releases  
http://support.microsoft.com/en-us/help/2687523

- Note:

if your Office media contain fallback en-us msi files, then you need en-us msp files too  
`clientshared32mui-en-us, clientshared64mui-en-us, clientsharedmui-en-us, officesuitemui-en-us`
...
https://github.com/abbodi1406/WHD/raw/master/files/Office2010-x64.txt  
https://github.com/abbodi1406/WHD/raw/master/files/Office2010-x86.txt

- Manually download updates that are listed in text files:  
```
office2010-kb2879953.txt
eqnedt322010-kb4011610.txt / for your Office language + en-us file
projectloc2010-kb3054882.txt / for your Project language
visioloc2010-kb2881025.txt / for your Visio language
```

* Optional:

Office Customization Tool (Admin folder in ISO), include patched oct.dll to load modified xml files

32-bit  
https://github.com/abbodi1406/WHD/raw/master/files/Admin2010x86.7z  
https://download.ru/files/Jlk81bWo

64-bit  
https://github.com/abbodi1406/WHD/raw/master/files/Admin2010x64.7z  
https://download.ru/files/bQ2J2Of1
...
* If you used Office media with SP1, delete all files from **Updates** folder (because they are obsolete)
...
* If you manually extracted proofloc2010-kb3203468 update, prepend proof files names with "proofloc" to differentiate it from SP2 files  
```
examples:
proofloc-proof-en-us.msp
Z_proofloc2010_kb3203468_x64_proof-fr-fr.msp
```

* Extract or move Service Pack msp files into "Updates" folder of work directory

* Change `_OfficeUpsourcer2010.cmd` options if needed (see below), then Run as administrator
