...
Function ProcessMSI(file)
	...
	QueryDatabase("INSERT INTO `AdminExecuteSequence` (`Action`,`Condition`,`Sequence`) VALUES ('CostInitialize',NULL,490)") 
	QueryDatabase("INSERT INTO `AdminExecuteSequence` (`Action`,`Condition`,`Sequence`) VALUES ('CostFinalize',NULL,630)") 
	QueryDatabase("INSERT INTO `AdminExecuteSequence` (`Action`,`Condition`,`Sequence`) VALUES ('FileCost',NULL,510)") 
	QueryDatabase("INSERT INTO `AdminExecuteSequence` (`Action`,`Condition`,`Sequence`) VALUES ('InstallValidate',NULL,1305)") 
	QueryDatabase("INSERT INTO `AdminExecuteSequence` (`Action`,`Condition`,`Sequence`) VALUES ('InstallInitialize',NULL,1420)") 
	...
	QueryDatabase("INSERT INTO `AdminExecuteSequence` (`Action`,`Condition`,`Sequence`) VALUES ('InstallFinalize',NULL,7900)") 
	db.commit : CheckError
	Set db = nothing
End Function