...
cd /d "%~dp0"
if not exist "Patches*.vbs" (
echo Error: Patches VBScripts are missing
goto :TheEnd
)
...
copy /y "Patches*.vbs" "_wi\" 1>nul 2>nul
cd _wi
ping 127.0.0.1 -n 5 >nul
for /f %%# in ('dir /b *.msi') do (
if exist Patches2007.vbs cscript.exe //NoLogo Patches2007.vbs %%#
if exist Patches2010.vbs cscript.exe //NoLogo Patches2010.vbs %%#
if exist Patches2013.vbs cscript.exe //NoLogo Patches2013.vbs %%#
if exist Patches2016.vbs cscript.exe //NoLogo Patches2016.vbs %%#
)
cd ..
rmdir /s /q _wi\
echo.
