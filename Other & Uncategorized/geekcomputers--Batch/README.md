# Batch Scripts by GeekComputers

A collection of useful batch scripts for Windows automation and system management.

## Original Repository

This collection is from [geekcomputers/Batch](https://github.com/geekcomputers/Batch)
...
- **whereis.cmd** - Utility to find files and programs.

- **doskey.cmd** - Configure doskey macros for command line.

## Usage

Run the appropriate batch file for your needs. Some scripts may require administrator privileges.
