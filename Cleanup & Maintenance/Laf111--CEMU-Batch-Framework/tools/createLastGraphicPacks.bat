...
REM    color 4F
    ...
    if %nbArgs% NEQ 5 (
        ...
        echo ERROR ^: on arguments passed ^! >> !cgpvLogFile!
        echo SYNTAXE ^: "!THIS_SCRIPT!" BFW_GP_FOLDER GAME_GP_FOLDER titleIdsList nativeHeight GAME_TITLE
        echo SYNTAXE ^: "!THIS_SCRIPT!" BFW_GP_FOLDER GAME_GP_FOLDER titleIdsList nativeHeight GAME_TITLE >> !cgpvLogFile!
        echo given {%*}
        echo given {%*} >> !cgpvLogFile!
        exit /b 99
        exit /b 99 >> !cgpvLogFile!
    )
    ...
    set "gfxp="!BFW_GP_FOLDER:"=!\!GAME_TITLE!\Graphics""
    ...
    echo Create !strBfwMaxVgfxp! graphic packs for !GAME_TITLE! >> !cgpvLogFile!
    echo =========================================================
    echo ========================================================= >> !cgpvLogFile!
...
REM : functions
    ...
    :initResGraphicPack
        ...
        echo version = !gfxPackVersion! >> !gfxpPath!
        echo. >> !gfxpPath!
    ...
    :fillResGraphicPack
        ...
        echo category = TV Resolution >> !gfxpPath!
    ...
    :addResolution
        ...
        echo + !wc!x!hc!!desc! GFX packs >> !cgpvLogFile!
    ...
    :createGfxPacks
        ...
        echo Create !ratioPassed:-=/! resolution packs >> !cgpvLogFile!
        echo ---------------------------------------------------------
        echo --------------------------------------------------------- >> !cgpvLogFile!
    ...
    :createResGP
        ...
        if !nbAr! EQU 0 (
            ...
            echo Unable to get desired aspect ratio ^(choosen during setup^) ^? >> !cgpvLogFile!
            echo Delete batchFW outputs and relaunch
            echo Delete batchFW outputs and relaunch >> !cgpvLogFile!
            exit /b 2
        ) else (
            set /A "nbAr-=1"
        )
